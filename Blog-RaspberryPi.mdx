...
- v1.8 需要 Ubuntu 22.04 才能正常运行
- v1.7.5 是兼容性和功能的平衡点，Ubuntu 20.04 可用
- v1.7.2 UI 不好用，并且我这边出现过奇怪的问题，不推荐使用

版本发布信息可参考：https://github.com/raspberrypi/rpi-imager/releases
...
主机镜像：Ubuntu 20.04.6 LTS (Focal Fossa)
